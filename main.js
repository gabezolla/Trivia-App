...
selectTheme.addEventListener('change', (e) => {    
    let link = 'https://opentdb.com/api.php?amount=50&category=11&type=multiple';
    if (e.target.value == 'Movies') link = 'https://opentdb.com/api.php?amount=50&category=11&type=multiple';
    else if (e.target.value == 'Music') link = 'https://opentdb.com/api.php?amount=50&category=12&type=multiple';
    else if (e.target.value == 'Video Games') link = 'https://opentdb.com/api.php?amount=50&category=12&type=multiple';
    else if (e.target.value == 'Computers') link = 'https://opentdb.com/api.php?amount=50&category=18&type=multiple';
    else if (e.target.value == 'Anime/Manga') link = 'https://opentdb.com/api.php?amount=50&category=31';
    createQuestion(link);
});
...
function createQuestion(link) {

    fetch(link) // para ter múltiplos temas, podemos armazenar link numa variavel e usar template string.
        .then(res => res.json())
        .then((out) => {
